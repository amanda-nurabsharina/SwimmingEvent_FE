...
/**
 * Converts a time string (e.g. "00.28.14", "02.29.50", "28.14") into total seconds.
 * Invalid/empty/DNF/DQ/DNS times return 9999999.
 */
...
/**
 * Formats time difference in seconds (+0.85s)
 */
...
/**
 * Analyzes an event and calculates champion podium (Juara 1, 2, 3) for Heat Angka,
 * or fastest winner per group for Group Abjad.
 */
export function calculateEventChampions(event: EventGroupData): EventChampionResult {
  ...
  if (!isGroup) {
    // =========================================================================
    // HEAT NUMBER (ANGKA): Juara 1, 2, 3 dipilih dari catatan waktu tercepat
    // di seluruh seri/heat pada nomor lomba ini (Timed Final).
    // =========================================================================
    ...
    // =========================================================================
    // GROUP ABJAD (A, B, C, D...): Sifatnya semua bisa juara!
    // Tampilkan perenang tercepat di SETIAP groupnya masing-masing.
    // =========================================================================
